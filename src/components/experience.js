  ...
  render(){
    return(
      ...
      <div style = {{backgroundColor:'white'}}>
         ...
         <Image src={require('/Users/sahil_21/Desktop/new_website/new_website2/new_website2/src/Assets/QaInfotech.jpeg')}  rounded style ={{height:'500px', width:'500px', border:'6px solid black' }} />
         </Col> </Row>
         </Container>
          </div>
      </div>
      <div style = {{backgroundColor:'#535C68'}}>
         ...
         <Row><Col lg={true}> <Image src={require('/Users/sahil_21/Desktop/new_website/new_website2/new_website2/src/Assets/1_tYZ8_SodwSUPJTuWQs-CoA.jpeg')}  rounded style ={{height:'500px', width:'500px', border:'6px solid black' }} /> </Col> <Col  style={{ color:'white', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder' }}><p> Working on emotion analysis to detect emotions from fiction novels particularly from project Gutenberg. I am currently working on collecting, catalouging and labelling data from fiction novels and </p> 
         <p> </p>
        </Col> </Row>
         </Container>
          </div>
