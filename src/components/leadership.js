...
<div  style={{height:'400px',opacity: '0.5', padding:'0px' ,backgroundImage: `url(${require('../Assets/hack2.jpg')})` }}>     
       ...
       I am really involved with the college of Engineering RSOs and participate in events and organizing student and administrative events. Having spent considerable time in these endevours, I have been able to develop skills nessecccary to work in a diverse and challenging spaces.
         ...
         <Row>
         <Col lg={true}  sm={12} style={{ color:'black', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder', paddingTop:'10%' , paddingBottom:'10%' }}> <h4 style = {{paddingRight:'10px'}}> Engineering Council Representative </h4>  <Image src={require('../Assets/engineering_council.png')}  rounded style ={{height:'50%', width:'100%', border:'5.0px solid black' }} />  represent my RSO Triangle on the engineering council. 
          Working on allocating funding to diffrent RSOs, working on collecting various types of issues and student affairs   </Col> 
          
          <Col lg={true} sm={12} style={{ color:'black', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder', paddingTop:'10%' , paddingBottom:'10%' }}> <h4 style = {{paddingRight:'10px'}}> MRDC(Midwestern Robo Design Competition) </h4>  <Image src={require('../Assets/Mrdc.jpeg')}  rounded style ={{height:'50%', width:'100%', border:'5.0px solid black' }} /> MRDC is the biggest Robotics competition in the midwest. With about 13 participating schools, my team is responsible for setting up hydraulics, collecting data from the ramp. </Col> 
         
         
          <Col lg={true}  sm={12} style={{ color:'black', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder', paddingTop:'10%' , paddingBottom:'10%' }}> <h4 style = {{paddingRight:'10px'}}> ESAA(Engineering Student Alumni Association) </h4>  <Image src={require('../Assets/ESAA.jpeg')}  rounded style ={{height:'50%', width:'100%', border:'5.0px solid black' }} />  
          ...
          <Row>
         <Col lg={2}  sm={12}> </Col>
         <Col lg={4}  sm={12} style={{ color:'black', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder' , paddingBottom:'5%'  }}> <h4 style = {{padding:'10px'}}> Technical Chair, Triangle </h4>  <Image src={require('../Assets/triamgleIma.jpeg')}  rounded style ={{height:'50%', width:'100%', border:'5.0px solid black' }} /> <pr> Resolved technical issues like managing WiFi, house server and other equipment in a house of 35 residents. </pr>   </Col> 
        <Col lg={4}  sm = {12}style={{ color:'black', fontFamily:'Montserrat', fontSize:'20px', fontWeight:'bolder' , paddingBottom:'10%'}}> <h4 style = {{padding:'10px'}}> League of Linguistics </h4>  <Image src={require('../Assets/lolimag.png')}  rounded style ={{height:'55%', width:'100%', border:'5.0px solid black' }} />  <pr> Actively lead projects on various teams in the field of computational linguistics.  </pr>   </Col> 
        <Col lg={2}  sm={12}> </Col>
        </Row>
        </Container>
          </div>
